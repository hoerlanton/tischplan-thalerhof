...
var DepartmentsComponent = (function () {
    ...
    DepartmentsComponent.prototype.changeBgColorIfAnreise = function () {
        var _this = this;
        setTimeout(function () {
            _this.tables = _this.tablesTempAbreise;
            console.log('================changeBgColorIfAnreise');
            _this.dateTodayGenerated = new Date();
            for (var a = 0; a < _this.tables.length; a++) {
                for (var b = 0; b < _this.tables[a].tables.length; b++) {
                    if (_this.tables[a].tables[b].anreiseValue) {
                        console.log('tables[a].tables[b].anreiseValue: ' + b + " " + _this.tables[a].tables[b].anreiseValue);
                        _this.parts[0] = _this.tables[a].tables[b].anreiseValue.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[0] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue2) {
                        _this.parts[1] = _this.tables[a].tables[b].anreiseValue2.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[1] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue3) {
                        _this.parts[2] = _this.tables[a].tables[b].anreiseValue3.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[2] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue4) {
                        _this.parts[3] = _this.tables[a].tables[b].anreiseValue4.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[3] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue5) {
                        _this.parts[4] = _this.tables[a].tables[b].anreiseValue5.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[4] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue6) {
                        _this.parts[5] = _this.tables[a].tables[b].anreiseValue6.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[5] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue7) {
                        _this.parts[6] = _this.tables[a].tables[b].anreiseValue7.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[6] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue8) {
                        _this.parts[7] = _this.tables[a].tables[b].anreiseValue8.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[7] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue9) {
                        _this.parts[8] = _this.tables[a].tables[b].anreiseValue9.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[8] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue10) {
                        _this.parts[9] = _this.tables[a].tables[b].anreiseValue10.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[9] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue11) {
                        _this.parts[10] = _this.tables[a].tables[b].anreiseValue11.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[10] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue12) {
                        _this.parts[11] = _this.tables[a].tables[b].anreiseValue12.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[11] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue13) {
                        _this.parts[12] = _this.tables[a].tables[b].anreiseValue13.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[12] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue14) {
                        _this.parts[13] = _this.tables[a].tables[b].anreiseValue14.match(/(\d+)/g);
                    }
                    else {
                        _this.parts[13] = "undefined";
                    }
                    if (_this.tables[a].tables[b].anreiseValue15) {
                        _this.parts[14] = _this.tables[a].tables[b].anreiseValue15.match(/(\d+)/g);
                    }
                    else {
...
DepartmentsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__services_tischplan_service__["a" /* TischplanService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_tischplan_service__["a" /* TischplanService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["ChangeDetectorRef"]) === "function" && _g || Object])
...
module.exports = "<div *ngIf=\"showTablePlanBool\">\n  <div id=\"printSectionId2\" class=\"col-xs-12 printTwo\">\n    <div class=\"row\" style=\"border-left: 5px solid #0a7a74; border-right: 5px solid #0a7a74;\">\n      <div *ngIf=\"showSonnbergZirbnBool\">\n        <div *ngFor=\"let tableSonnbergZirbn of tablesSonnbergZirbn; let j = index;\">\n          <div dropdownToggle type=\"button\" class=\"t{{tableSonnbergZirbn.number}} table-item\" [ngStyle]=\"{'top': tableSonnbergZirbn.topValue + 'px', 'left': tableSonnbergZirbn.leftValue + 'px', 'background-color': + tableSonnbergZirbn.bgColor, 'height': + tableSonnbergZirbn.height + 'px', 'width': + tableSonnbergZirbn.width + 'px', 'border': + tableSonnbergZirbn.border}\" [style.border]=\"getStyle(tablesSonnbergZirbn[j].trace, tablesSonnbergZirbn[j].trace2, tablesSonnbergZirbn[j].trace3, tablesSonnbergZirbn[j].trace4, tablesSonnbergZirbn[j].trace5, tablesSonnbergZirbn[j].trace6, tablesSonnbergZirbn[j].trace7, tablesSonnbergZirbn[j].trace8, tablesSonnbergZirbn[j].trace9, tablesSonnbergZirbn[j].trace10, tablesSonnbergZirbn[j].trace11, tablesSonnbergZirbn[j].trace12, tablesSonnbergZirbn[j].trace13, tablesSonnbergZirbn[j].trace14, tablesSonnbergZirbn[j].trace15, tablesSonnbergZirbn[j].newTraceText)\" dropdown>\n            <div *ngIf=\"tablesSonnbergZirbn[j] !== tablesSonnbergZirbn[j+1]\">\n              <p><b>{{tableSonnbergZirbn.number}} | {{tableSonnbergZirbn.personenAnzahlValue}} {{tableSonnbergZirbn.personenAnzahlValue2}} {{tableSonnbergZirbn.personenAnzahlValue3}} {{tableSonnbergZirbn.personenAnzahlValue4}} {{tableSonnbergZirbn.personenAnzahlValue5}} {{tableSonnbergZirbn.personenAnzahlValue6}} {{tableSonnbergZirbn.personenAnzahlValue7}} {{tableSonnbergZirbn.personenAnzahlValue8}} {{tableSonnbergZirbn.personenAnzahlValue9}} {{tableSonnbergZirbn.personenAnzahlValue10}}  {{tableSonnbergZirbn.personenAnzahlValue11}}  {{tableSonnbergZirbn.personenAnzahlValue12}}  {{tableSonnbergZirbn.personenAnzahlValue13}}  {{tableSonnbergZirbn.personenAnzahlValue14}}  {{tableSonnbergZirbn.personenAnzahlValue15}}</b></p>\n            </div>\n            <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">\n              <div dropdownToggle type=\"button\" style=\"color: white; padding: 10px;\" (mouseenter)=\"mouseEnterMoveTableButton()\"  (mouseleave)=\"mouseLeaveMoveTableButton()\" [ngStyle]=\"{'background-color': '#' + buttonMoveTable}\" (click)=\"none($event)\" class=\"dropdownMoveTable\" dropdown><b>Tisch verschieben</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; margin: 0; overflow: auto\">\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"addTable(tableSonnbergZirbn, j)\" (mouseenter)=\"mouseEnterHinzufuegenButton()\"  (mouseleave)=\"mouseLeaveHinzufuegenButton()\" [ngStyle]=\"{'background-color': '#' + buttonHinzufuegen}\" ><b>Tisch hinzufügen</b></li>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0\"></li>\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"removeTable(tableSonnbergZirbn, j)\" (mouseenter)=\"mouseEnterEntfernenButton()\"  (mouseleave)=\"mouseLeaveEntfernenButton()\" [ngStyle]=\"{'background-color': '#' + buttonEntfernen}\" ><b>Tisch entfernen</b></li>\n                </div>\n              </div>\n              <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0;\"></li>\n              <div dropdownToggle type=\"button\" (click)=\"none($event)\" style=\"padding: 10px\" (mouseenter)=\"mouseEnterInfoButton()\"  (mouseleave)=\"mouseLeaveInfoButton()\" [ngStyle]=\"{'background-color': '#' + buttonInfo}\" class=\"dropdownShowinfo\" dropdown><b>Infos anzeigen</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; padding: 10px; overflow: auto\">\n                <div *ngIf=\"tableSonnbergZirbn.nameValue\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace)\" ><b>Name:</b> {{tableSonnbergZirbn.nameValue}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue2\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace2)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue2}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue2}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue2}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue2}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue2}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue2}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue2}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue2}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value2}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace2}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue3\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace3)\" ><b>Name:</b> {{tableSonnbergZirbn.nameValue3}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue3}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue3}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue3}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue3}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue3}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue3}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue3}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value3}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace3}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue4\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace4)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue4}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue4}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue4}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue4}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue4}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue4}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue4}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue4}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value4}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace4}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue5\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace5)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue5}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue5}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue5}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue5}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue5}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue5}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue5}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue5}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value5}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace5}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue6\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace6)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue6}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue6}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue6}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue6}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue6}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue6}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue6}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue6}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value6}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace6}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue7\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace7)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue7}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue7}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue7}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue7}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue7}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue7}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue7}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue7}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value7}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace7}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue8\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace8)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue8}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue8}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue8}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue8}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue8}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue8}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue8}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue8}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value8}}<b>Trace:</b> {{tableSonnbergZirbn.trace8}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue9\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace9)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue9}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue9}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue9}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue9}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue9}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue9}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue9}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue9}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value9}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace9}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue10\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace10)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue10}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue10}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue10}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue10}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue10}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue10}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue10}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue10}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value10}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace10}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue11\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace11)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue11}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue11}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue11}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue11}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue11}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue11}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue11}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue11}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value11}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace11}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue12\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace12)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue12}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue12}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue12}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue12}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue12}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue12}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue12}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue12}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value12}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace12}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue13\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace13)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue13}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue13}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue13}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue13}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue13}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue13}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue13}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue13}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value13}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace13}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue14\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace14)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue14}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue14}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue14}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue14}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue14}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue14}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue14}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue14}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value14}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace14}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableSonnbergZirbn.nameValue15\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesSonnbergZirbn[j].trace15)\"><b>Name:</b> {{tableSonnbergZirbn.nameValue15}}<br><b>Sprache:</b> {{tableSonnbergZirbn.spracheValue15}}<br><b>Zimmer Nummer: </b>{{tableSonnbergZirbn.zimmernummerValue15}}<br><b>Preistyp: </b>{{tableSonnbergZirbn.preistypValue15}}<br><b>Anreise: </b>{{tableSonnbergZirbn.anreiseValue15}}<br><b>Abreise:</b> {{tableSonnbergZirbn.abreiseValue15}}<br><b>Personen Anzahl:</b>{{tableSonnbergZirbn.personenAnzahlValue15}}<br><b>Reisebüro: </b>{{tableSonnbergZirbn.rbsouValue15}}<br><b>Notiz2:</b> {{tableSonnbergZirbn.notiz2Value15}}<br><b>Trace:</b> {{tableSonnbergZirbn.trace15}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                  <div *ngIf=\"tableSonnbergZirbn.newTraceText\">\n                    <div class=\"dropdown-item\" style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableSonnbergZirbn.newTraceRoomNumber}}<br> <b> Neuer Trace: </b>{{tableSonnbergZirbn.newTraceText}} <br> <b> Tischnummer: </b>{{tableSonnbergZirbn.newTraceTableNumber}} <br> <b> Mitarbeiter: </b>{{tableSonnbergZirbn.newTraceEmployee}} <br> <b> Name: </b>{{tableSonnbergZirbn.newTraceName}} <br> <b> Datum: </b>{{tableSonnbergZirbn.newTraceDate}}\n                    </div>\n                  </div>\n                  <div *ngIf=\"tableSonnbergZirbn.newTraceText1\">\n                    <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                    <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableSonnbergZirbn.newTraceRoomNumber1}}<br> <b> Neuer Trace: </b>{{tableSonnbergZirbn.newTraceText1}} <br> <b> Tischnummer: </b>{{tableSonnbergZirbn.newTraceTableNumber1}} <br> <b> Mitarbeiter: </b>{{tableSonnbergZirbn.newTraceEmployee1}} <br> <b> Name: </b>{{tableSonnbergZirbn.newTraceName1}} <br> <b> Datum: </b>{{tableSonnbergZirbn.newTraceDate1}}\n                    </div>\n                  </div>\n                  <div *ngIf=\"tableSonnbergZirbn.newTraceText2\">\n                    <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                    <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableSonnbergZirbn.newTraceRoomNumber2}}<br> <b> Neuer Trace: </b>{{tableSonnbergZirbn.newTraceText2}} <br> <b> Tischnummer: </b>{{tableSonnbergZirbn.newTraceTableNumber2}} <br> <b> Mitarbeiter: </b>{{tableSonnbergZirbn.newTraceEmployee2}} <br> <b> Name: </b>{{tableSonnbergZirbn.newTraceName2}} <br> <b> Datum: </b>{{tableSonnbergZirbn.newTraceDate2}}\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"showPanoramaBool\">\n        <div *ngFor=\"let tablePanorama of tablesPanorama; let j = index;\">\n          <div dropdownToggle type=\"button\"  class=\"t{{tablePanorama.number}} table-item\" [ngStyle]=\"{'top': tablePanorama.topValue + 'px', 'left': tablePanorama.leftValue + 'px', 'background-color': + tablePanorama.bgColor,  'height': + tablePanorama.height + 'px', 'width': + tablePanorama.width + 'px', 'border': + tablePanorama.border}\" [style.border]=\"getStyle(tablesPanorama[j].trace, tablesPanorama[j].trace2, tablesPanorama[j].trace3, tablesPanorama[j].trace4, tablesPanorama[j].trace5, tablesPanorama[j].trace6, tablesPanorama[j].trace7, tablesPanorama[j].trace8, tablesPanorama[j].trace9, tablesPanorama[j].trace10, tablesPanorama[j].trace11, tablesPanorama[j].trace12, tablesPanorama[j].trace13, tablesPanorama[j].trace14, tablesPanorama[j].trace15, tablesPanorama[j].newTraceText)\" dropdown>\n            <div *ngIf=\"tablesPanorama[j] !== tablesPanorama[j+1]\">\n              <p><b>{{tablePanorama.number}} | {{tablePanorama.personenAnzahlValue}} {{tablePanorama.personenAnzahlValue2}} {{tablePanorama.personenAnzahlValue3}} {{tablePanorama.personenAnzahlValue4}} {{tablePanorama.personenAnzahlValue5}} {{tablePanorama.personenAnzahlValue6}} {{tablePanorama.personenAnzahlValue7}} {{tablePanorama.personenAnzahlValue8}} {{tablePanorama.personenAnzahlValue9}} {{tablePanorama.personenAnzahlValue10}} {{tablePanorama.personenAnzahlValue11}} {{tablePanorama.personenAnzahlValue12}} {{tablePanorama.personenAnzahlValue13}} {{tablePanorama.personenAnzahlValue14}} {{tablePanorama.personenAnzahlValue15}}</b></p>\n              </div>\n            <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">\n              <div dropdownToggle type=\"button\" style=\"color: white; padding: 10px;\" (mouseenter)=\"mouseEnterMoveTableButton()\"  (mouseleave)=\"mouseLeaveMoveTableButton()\" [ngStyle]=\"{'background-color': '#' + buttonMoveTable}\" (click)=\"none($event)\" class=\"dropdownMoveTable\" dropdown><b>Tisch verschieben</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; padding: 0px; margin: 0; overflow: auto\">\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"addTable(tablePanorama, j)\" (mouseenter)=\"mouseEnterHinzufuegenButton()\"  (mouseleave)=\"mouseLeaveHinzufuegenButton()\" [ngStyle]=\"{'background-color': '#' + buttonHinzufuegen}\" ><b>Tisch hinzufügen</b></li>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0;\"></li>\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"removeTable(tablePanorama, j)\" (mouseenter)=\"mouseEnterEntfernenButton()\"  (mouseleave)=\"mouseLeaveEntfernenButton()\" [ngStyle]=\"{'background-color': '#' + buttonEntfernen}\" ><b>Tisch entfernen</b></li>\n                </div>\n              </div>\n              <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0;\"></li>\n              <div dropdownToggle type=\"button\" (click)=\"none($event)\" style=\"padding: 10px\" (mouseenter)=\"mouseEnterInfoButton()\"  (mouseleave)=\"mouseLeaveInfoButton()\" [ngStyle]=\"{'background-color': '#' + buttonInfo}\"  class=\"dropdownShowinfo\" dropdown><b>Infos anzeigen</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; padding: 10px; overflow: auto\">\n                <div *ngIf=\"tablePanorama.nameValue\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace)\"><b>Name:</b> {{tablePanorama.nameValue}}<br><b>Sprache:</b> {{tablePanorama.spracheValue}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value}}<br><b>Trace:</b> {{tablePanorama.trace}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue2\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace2)\"><b>Name:</b> {{tablePanorama.nameValue2}}<br><b>Sprache:</b> {{tablePanorama.spracheValue2}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue2}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue2}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue2}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue2}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue2}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue2}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value2}}<br><b>Trace:</b> {{tablePanorama.trace2}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue3\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace3)\"><b>Name:</b> {{tablePanorama.nameValue3}}<br><b>Sprache:</b> {{tablePanorama.spracheValue3}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue3}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue3}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue3}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue3}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue3}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue3}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value3}}<br><b>Trace:</b> {{tablePanorama.trace3}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue4\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace4)\"><b>Name:</b> {{tablePanorama.nameValue4}}<br><b>Sprache:</b> {{tablePanorama.spracheValue4}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue4}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue4}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue4}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue4}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue4}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue4}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value4}}<br><b>Trace:</b> {{tablePanorama.trace4}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue5\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace5)\"><b>Name:</b> {{tablePanorama.nameValue5}}<br><b>Sprache:</b> {{tablePanorama.spracheValue5}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue5}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue5}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue5}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue5}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue5}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue5}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value5}}<br><b>Trace:</b> {{tablePanorama.trace5}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue6\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace6)\"><b>Name:</b> {{tablePanorama.nameValue6}}<br><b>Sprache:</b> {{tablePanorama.spracheValue6}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue6}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue6}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue6}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue6}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue6}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue6}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value6}}<br><b>Trace:</b> {{tablePanorama.trace6}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue7\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace7)\"><b>Name:</b> {{tablePanorama.nameValue7}}<br><b>Sprache:</b> {{tablePanorama.spracheValue7}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue7}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue7}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue7}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue7}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue7}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue7}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value7}}<br><b>Trace:</b> {{tablePanorama.trace7}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue8\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace8)\"><b>Name:</b> {{tablePanorama.nameValue8}}<br><b>Sprache:</b> {{tablePanorama.spracheValue8}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue8}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue8}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue8}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue8}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue8}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue8}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value8}}<br><b>Trace:</b> {{tablePanorama.trace8}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue9\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace9)\"><b>Name:</b> {{tablePanorama.nameValue9}}<br><b>Sprache:</b> {{tablePanorama.spracheValue9}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue9}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue9}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue9}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue9}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue9}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue9}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value9}}<br><b>Trace:</b> {{tablePanorama.trace9}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue10\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace10)\"><b>Name:</b> {{tablePanorama.nameValue10}}<br><b>Sprache:</b> {{tablePanorama.spracheValue10}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue10}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue10}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue10}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue10}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue10}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue10}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value10}}<br><b>Trace:</b> {{tablePanorama.trace10}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue11\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace11)\"><b>Name:</b> {{tablePanorama.nameValue11}}<br><b>Sprache:</b> {{tablePanorama.spracheValue11}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue11}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue11}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue11}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue11}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue11}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue11}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value11}}<br><b>Trace:</b> {{tablePanorama.trace11}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue12\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace12)\"><b>Name:</b> {{tablePanorama.nameValue12}}<br><b>Sprache:</b> {{tablePanorama.spracheValue12}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue12}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue12}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue12}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue12}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue12}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue12}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value12}}<br><b>Trace:</b> {{tablePanorama.trace12}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue13\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace13)\"><b>Name:</b> {{tablePanorama.nameValue13}}<br><b>Sprache:</b> {{tablePanorama.spracheValue13}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue13}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue13}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue13}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue13}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue13}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue13}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value13}}<br><b>Trace:</b> {{tablePanorama.trace13}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue14\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace14)\"><b>Name:</b> {{tablePanorama.nameValue14}}<br><b>Sprache:</b> {{tablePanorama.spracheValue14}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue14}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue14}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue14}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue14}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue14}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue14}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value14}}<br><b>Trace:</b> {{tablePanorama.trace14}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.nameValue15\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesPanorama[j].trace15)\"><b>Name:</b> {{tablePanorama.nameValue15}}<br><b>Sprache:</b> {{tablePanorama.spracheValue15}}<br><b>Zimmer Nummer: </b>{{tablePanorama.zimmernummerValue15}}<br><b>Preistyp: </b>{{tablePanorama.preistypValue15}}<br><b>Anreise: </b>{{tablePanorama.anreiseValue15}}<br><b>Abreise:</b> {{tablePanorama.abreiseValue15}}<br><b>Personen Anzahl:</b>{{tablePanorama.personenAnzahlValue15}}<br><b>Reisebüro: </b>{{tablePanorama.rbsouValue15}}<br><b>Notiz2:</b> {{tablePanorama.notiz2Value15}}<br><b>Trace:</b> {{tablePanorama.trace15}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tablePanorama.newTraceText\">\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tablePanorama.newTraceRoomNumber}}<br> <b> Neuer Trace: </b>{{tablePanorama.newTraceText}} <br> <b> Tischnummer: </b>{{tablePanorama.newTraceTableNumber}} <br> <b> Mitarbeiter: </b>{{tablePanorama.newTraceEmployee}} <br> <b> Name: </b>{{tablePanorama.newTraceName}} <br> <b> Datum: </b>{{tablePanorama.newTraceDate}}\n                  </div>\n                </div>\n                <div *ngIf=\"tablePanorama.newTraceText1\">\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tablePanorama.newTraceRoomNumber1}}<br> <b> Neuer Trace: </b>{{tablePanorama.newTraceText1}} <br> <b> Tischnummer: </b>{{tablePanorama.newTraceTableNumber1}} <br> <b> Mitarbeiter: </b>{{tablePanorama.newTraceEmployee1}} <br> <b> Name: </b>{{tablePanorama.newTraceName1}} <br> <b> Datum: </b>{{tablePanorama.newTraceDate1}}\n                  </div>\n                </div>\n                <div *ngIf=\"tablePanorama.newTraceText2\">\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tablePanorama.newTraceRoomNumber2}}<br> <b> Neuer Trace: </b>{{tablePanorama.newTraceText2}} <br> <b> Tischnummer: </b>{{tablePanorama.newTraceTableNumber2}} <br> <b> Mitarbeiter: </b>{{tablePanorama.newTraceEmployee2}} <br> <b> Name: </b>{{tablePanorama.newTraceName2}} <br> <b> Datum: </b>{{tablePanorama.newTraceDate2}}\n                  </div>\n                </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"showRestaurantBool\">\n        <div *ngFor=\"let tableRestaurant of tablesRestaurant; let j = index;\">\n          <div dropdownToggle type=\"button\" class=\"t{{tableRestaurant.number}} table-item\" [ngStyle]=\"{'top': tableRestaurant.topValue + 'px', 'left': tableRestaurant.leftValue + 'px', 'background-color': + tableRestaurant.bgColor, 'height': + tableRestaurant.height + 'px', 'width': + tableRestaurant.width + 'px', 'border': + tableRestaurant.border}\" [style.border]=\"getStyle(tablesRestaurant[j].trace, tablesRestaurant[j].trace2, tablesRestaurant[j].trace3, tablesRestaurant[j].trace4, tablesRestaurant[j].trace5, tablesRestaurant[j].trace6, tablesRestaurant[j].trace7, tablesRestaurant[j].trace8, tablesRestaurant[j].trace9, tablesRestaurant[j].trace10, tablesRestaurant[j].trace11, tablesRestaurant[j].trace12, tablesRestaurant[j].trace13, tablesRestaurant[j].trace14, tablesRestaurant[j].trace15, tablesRestaurant[j].newTraceText)\" dropdown>\n            <div *ngIf=\"tablesRestaurant[j] !== tablesRestaurant[j+1]\">\n              <p><b>{{tableRestaurant.number}} | {{tableRestaurant.personenAnzahlValue}} {{tableRestaurant.personenAnzahlValue2}} {{tableRestaurant.personenAnzahlValue3}} {{tableRestaurant.personenAnzahlValue4}} {{tableRestaurant.personenAnzahlValue5}} {{tableRestaurant.personenAnzahlValue6}} {{tableRestaurant.personenAnzahlValue7}} {{tableRestaurant.personenAnzahlValue8}} {{tableRestaurant.personenAnzahlValue9}} {{tableRestaurant.personenAnzahlValue10}}  {{tableRestaurant.personenAnzahlValue11}} {{tableRestaurant.personenAnzahlValue12}} {{tableRestaurant.personenAnzahlValue13}} {{tableRestaurant.personenAnzahlValue14}} {{tableRestaurant.personenAnzahlValue15}} </b></p>\n              </div>\n            <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">\n              <div dropdownToggle type=\"button\" style=\"color: white; padding: 10px;\" (mouseenter)=\"mouseEnterMoveTableButton()\"  (mouseleave)=\"mouseLeaveMoveTableButton()\" [ngStyle]=\"{'background-color': '#' + buttonMoveTable}\" (click)=\"none($event)\" class=\"dropdownMoveTable\" dropdown><b>Tisch verschieben</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; margin: 0; padding: 0px; overflow: auto\">\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"addTable(tableRestaurant, j)\" (mouseenter)=\"mouseEnterHinzufuegenButton()\"  (mouseleave)=\"mouseLeaveHinzufuegenButton()\" [ngStyle]=\"{'background-color': '#' + buttonHinzufuegen}\" ><b>Tisch hinzufügen</b></li>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0\"></li>\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"removeTable(tableRestaurant, j)\" (mouseenter)=\"mouseEnterEntfernenButton()\"  (mouseleave)=\"mouseLeaveEntfernenButton()\" [ngStyle]=\"{'background-color': '#' + buttonEntfernen}\" ><b>Tisch entfernen</b></li>\n                </div>\n              </div>\n              <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0;\"></li>\n              <div dropdownToggle type=\"button\" (click)=\"none($event)\" style=\"padding: 10px\" (mouseenter)=\"mouseEnterInfoButton()\"  (mouseleave)=\"mouseLeaveInfoButton()\" [ngStyle]=\"{'background-color': '#' + buttonInfo}\"  class=\"dropdownShowinfo\" dropdown><b>Infos anzeigen</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; padding: 10px; overflow: auto\">\n                <div *ngIf=\"tableRestaurant.nameValue\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace)\"><b>Name:</b> {{tableRestaurant.nameValue}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value}}<br><b>Trace:</b> {{tableRestaurant.trace}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue2\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace2)\"><b>Name:</b> {{tableRestaurant.nameValue2}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue2}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue2}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue2}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue2}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue2}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue2}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue2}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value2}}<br><b>Trace:</b> {{tableRestaurant.trace2}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue3\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace3)\"><b>Name:</b> {{tableRestaurant.nameValue3}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue3}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue3}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue3}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue3}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue3}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue3}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue3}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value3}}<br><b>Trace:</b> {{tableRestaurant.trace3}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue4\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace4)\"><b>Name:</b> {{tableRestaurant.nameValue4}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue4}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue4}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue4}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue4}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue4}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue4}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue4}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value4}}<br><b>Trace:</b> {{tableRestaurant.trace4}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue5\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace5)\"><b>Name:</b> {{tableRestaurant.nameValue5}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue5}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue5}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue5}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue5}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue5}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue5}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue5}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value5}}<br><b>Trace:</b> {{tableRestaurant.trace5}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue6\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace6)\"><b>Name:</b> {{tableRestaurant.nameValue6}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue6}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue6}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue6}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue6}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue6}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue6}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue6}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value6}}<br><b>Trace:</b> {{tableRestaurant.trace6}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue7\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace7)\"><b>Name:</b> {{tableRestaurant.nameValue7}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue7}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue7}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue7}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue7}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue7}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue7}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue7}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value7}}<br><b>Trace:</b> {{tableRestaurant.trace7}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue8\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace8)\"><b>Name:</b> {{tableRestaurant.nameValue8}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue8}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue8}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue8}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue8}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue8}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue8}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue8}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value8}}<br><b>Trace:</b> {{tableRestaurant.trace8}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue9\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace9)\"><b>Name:</b> {{tableRestaurant.nameValue9}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue9}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue9}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue9}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue9}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue9}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue9}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue9}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value9}}<br><b>Trace:</b> {{tableRestaurant.trace9}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue10\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace10)\"><b>Name:</b> {{tableRestaurant.nameValue10}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue10}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue10}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue10}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue10}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue10}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue10}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue10}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value10}}<br><b>Trace:</b> {{tableRestaurant.trace10}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue11\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace11)\"><b>Name:</b> {{tableRestaurant.nameValue11}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue11}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue11}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue11}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue11}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue11}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue11}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue11}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value11}}<br><b>Trace:</b> {{tableRestaurant.trace11}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue12\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace12)\"><b>Name:</b> {{tableRestaurant.nameValue12}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue12}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue12}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue12}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue12}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue12}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue12}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue12}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value12}}<br><b>Trace:</b> {{tableRestaurant.trace12}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue13\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace13)\"><b>Name:</b> {{tableRestaurant.nameValue13}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue13}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue13}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue13}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue13}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue13}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue13}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue13}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value13}}<br><b>Trace:</b> {{tableRestaurant.trace13}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue14\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace14)\"><b>Name:</b> {{tableRestaurant.nameValue14}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue14}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue14}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue14}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue14}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue14}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue14}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue14}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value14}}<br><b>Trace:</b> {{tableRestaurant.trace14}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableRestaurant.nameValue15\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesRestaurant[j].trace15)\"><b>Name:</b> {{tableRestaurant.nameValue15}}<br><b>Sprache:</b> {{tableRestaurant.spracheValue15}}<br><b>Zimmer Nummer: </b>{{tableRestaurant.zimmernummerValue15}}<br><b>Preistyp: </b>{{tableRestaurant.preistypValue15}}<br><b>Anreise: </b>{{tableRestaurant.anreiseValue15}}<br><b>Abreise:</b> {{tableRestaurant.abreiseValue15}}<br><b>Personen Anzahl:</b>{{tableRestaurant.personenAnzahlValue15}}<br><b>Reisebüro: </b>{{tableRestaurant.rbsouValue15}}<br><b>Notiz2:</b> {{tableRestaurant.notiz2Value15}}<br><b>Trace:</b> {{tableRestaurant.trace15}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                  <div *ngIf=\"tableRestaurant.newTraceText\">\n                    <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableRestaurant.newTraceRoomNumber}}<br> <b> Neuer Trace: </b>{{tableRestaurant.newTraceText}} <br> <b> Tischnummer: </b>{{tableRestaurant.newTraceTableNumber}} <br> <b> Mitarbeiter: </b>{{tableRestaurant.newTraceEmployee}} <br> <b> Name: </b>{{tableRestaurant.newTraceName}} <br> <b> Datum: </b>{{tableRestaurant.newTraceDate}}\n                    </div>\n                  </div>\n                  <div *ngIf=\"tableRestaurant.newTraceText1\">\n                    <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                    <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableRestaurant.newTraceRoomNumber1}}<br> <b> Neuer Trace: </b>{{tableRestaurant.newTraceText1}} <br> <b> Tischnummer: </b>{{tableRestaurant.newTraceTableNumber1}} <br> <b> Mitarbeiter: </b>{{tableRestaurant.newTraceEmployee1}} <br> <b> Name: </b>{{tableRestaurant.newTraceName1}} <br> <b> Datum: </b>{{tableRestaurant.newTraceDate1}}\n                    </div>\n                  </div>\n                  <div *ngIf=\"tableRestaurant.newTraceText2\">\n                    <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                    <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                      <b> Zimmernummer: </b>{{tableRestaurant.newTraceRoomNumber2}}<br> <b> Neuer Trace: </b>{{tableRestaurant.newTraceText2}} <br> <b> Tischnummer: </b>{{tableRestaurant.newTraceTableNumber2}} <br> <b> Mitarbeiter: </b>{{tableRestaurant.newTraceEmployee2}} <br> <b> Name: </b>{{tableRestaurant.newTraceName2}} <br> <b> Datum: </b>{{tableRestaurant.newTraceDate2}}\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"showWintergartenBool\">\n        <div *ngFor=\"let tableWintergarten of tablesWintergarten; let j = index;\">\n          <div dropdownToggle type=\"button\" class=\"t{{tableWintergarten.number}} table-item\" [ngStyle]=\"{'top': tableWintergarten.topValue + 'px', 'left': tableWintergarten.leftValue + 'px', 'background-color': + tableWintergarten.bgColor,  'height': + tableWintergarten.height + 'px', 'width': + tableWintergarten.width + 'px', 'border': + tableWintergarten.border, 'border-radius': + tableWintergarten.borderRadius, 'transform':  + tableWintergarten.transformValue}\" [style.border]=\"getStyle(tablesWintergarten[j].trace, tablesWintergarten[j].trace2, tablesWintergarten[j].trace3, tablesWintergarten[j].trace4, tablesWintergarten[j].trace5, tablesWintergarten[j].trace6, tablesWintergarten[j].trace7, tablesWintergarten[j].trace8, tablesWintergarten[j].trace9, tablesWintergarten[j].trace10, tablesWintergarten[j].trace11, tablesWintergarten[j].trace12, tablesWintergarten[j].trace13, tablesWintergarten[j].trace14, tablesWintergarten[j].trace15, tablesWintergarten[j].newTraceText)\" dropdown>\n            <div *ngIf=\"tablesWintergarten[j] !== tablesWintergarten[j+1]\">\n              <p><b>{{tableWintergarten.number}} | {{tableWintergarten.personenAnzahlValue}} {{tableWintergarten.personenAnzahlValue2}} {{tableWintergarten.personenAnzahlValue3}} {{tableWintergarten.personenAnzahlValue4}} {{tableWintergarten.personenAnzahlValue5}} {{tableWintergarten.personenAnzahlValue6}} {{tableWintergarten.personenAnzahlValue7}} {{tableWintergarten.personenAnzahlValue8}} {{tableWintergarten.personenAnzahlValue9}} {{tableWintergarten.personenAnzahlValue10}} {{tableWintergarten.personenAnzahlValue11}} {{tableWintergarten.personenAnzahlValue12}} {{tableWintergarten.personenAnzahlValue13}} {{tableWintergarten.personenAnzahlValue14}} {{tableWintergarten.personenAnzahlValue15}}</b></p>\n              </div>\n            <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\">\n              <div dropdownToggle type=\"button\" style=\"color: white; padding: 10px;\" (mouseenter)=\"mouseEnterMoveTableButton()\"  (mouseleave)=\"mouseLeaveMoveTableButton()\" [ngStyle]=\"{'background-color': '#' + buttonMoveTable}\" (click)=\"none($event)\" class=\"dropdownMoveTable\" dropdown><b>Tisch verschieben</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; margin: 0; padding: 0px; overflow: auto\">\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"addTable(tableWintergarten, j)\" (mouseenter)=\"mouseEnterHinzufuegenButton()\"  (mouseleave)=\"mouseLeaveHinzufuegenButton()\" [ngStyle]=\"{'background-color': '#' + buttonHinzufuegen}\" ><b>Tisch hinzufügen</b></li>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0\"></li>\n                  <li class=\"dropdown-item\" style=\"padding: 10px; color: black\" (click)=\"removeTable(tableWintergarten, j)\" (mouseenter)=\"mouseEnterEntfernenButton()\"  (mouseleave)=\"mouseLeaveEntfernenButton()\" [ngStyle]=\"{'background-color': '#' + buttonEntfernen}\" ><b>Tisch entfernen</b></li>\n                </div>\n              </div>\n              <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0; margin: 0;\"></li>\n              <div dropdownToggle type=\"button\" (click)=\"none($event)\" style=\"padding: 10px\" (mouseenter)=\"mouseEnterInfoButton()\"  (mouseleave)=\"mouseLeaveInfoButton()\" [ngStyle]=\"{'background-color': '#' + buttonInfo}\"  class=\"dropdownShowinfo\" dropdown><b>Infos anzeigen</b>\n                <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\" style=\"max-height: 240px; padding: 10px; overflow: auto\">\n                <div *ngIf=\"tableWintergarten.nameValue\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace)\"><b>Name:</b> {{tableWintergarten.nameValue}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value}}<br><b>Trace:</b> {{tableWintergarten.trace}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue2\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace2)\"><b>Name:</b> {{tableWintergarten.nameValue2}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue2}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue2}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue2}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue2}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue2}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue2}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue2}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value2}}<br><b>Trace:</b> {{tableWintergarten.trace2}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue3\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace3)\"><b>Name:</b> {{tableWintergarten.nameValue3}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue3}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue3}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue3}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue3}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue3}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue3}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue3}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value3}}<br><b>Trace:</b> {{tableWintergarten.trace3}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue4\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace4)\"><b>Name:</b> {{tableWintergarten.nameValue4}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue4}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue4}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue4}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue4}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue4}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue4}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue4}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value4}}<br><b>Trace:</b> {{tableWintergarten.trace4}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue5\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace5)\"><b>Name:</b> {{tableWintergarten.nameValue5}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue5}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue5}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue5}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue5}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue5}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue5}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue5}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value5}}<br><b>Trace:</b> {{tableWintergarten.trace5}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue6\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace6)\"><b>Name:</b> {{tableWintergarten.nameValue6}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue6}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue6}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue6}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue6}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue6}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue6}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue6}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value6}}<br><b>Trace:</b> {{tableWintergarten.trace6}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue7\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace7)\"><b>Name:</b> {{tableWintergarten.nameValue7}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue7}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue7}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue7}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue7}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue7}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue7}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue7}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value7}}<br><b>Trace:</b> {{tableWintergarten.trace7}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue8\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace8)\"><b>Name:</b> {{tableWintergarten.nameValue8}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue8}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue8}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue8}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue8}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue8}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue8}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue8}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value8}}<br><b>Trace:</b> {{tableWintergarten.trace8}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue9\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace9)\"><b>Name:</b> {{tableWintergarten.nameValue9}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue9}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue9}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue9}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue9}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue9}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue9}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue9}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value9}}<br><b>Trace:</b> {{tableWintergarten.trace9}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue10\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace10)\"><b>Name:</b> {{tableWintergarten.nameValue10}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue10}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue10}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue10}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue10}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue10}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue10}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue10}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value10}}<br><b>Trace:</b> {{tableWintergarten.trace10}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue11\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace11)\"><b>Name:</b> {{tableWintergarten.nameValue11}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue11}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue11}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue11}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue11}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue11}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue11}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue11}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value11}}<br><b>Trace:</b> {{tableWintergarten.trace11}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue12\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace12)\"><b>Name:</b> {{tableWintergarten.nameValue12}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue12}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue12}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue12}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue12}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue12}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue12}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue12}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value12}}<br><b>Trace:</b> {{tableWintergarten.trace12}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue13\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace13)\"><b>Name:</b> {{tableWintergarten.nameValue13}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue13}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue13}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue13}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue13}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue13}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue13}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue13}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value13}}<br><b>Trace:</b> {{tableWintergarten.trace13}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue14\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace14)\"><b>Name:</b> {{tableWintergarten.nameValue14}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue14}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue14}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue14}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue14}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue14}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue14}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue14}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value14}}<br><b>Trace:</b> {{tableWintergarten.trace14}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.nameValue15\">\n                  <div class=\"dropdown-item\" [style.border]=\"getStyleTrace(tablesWintergarten[j].trace15)\"><b>Name:</b> {{tableWintergarten.nameValue15}}<br><b>Sprache:</b> {{tableWintergarten.spracheValue15}}<br><b>Zimmer Nummer: </b>{{tableWintergarten.zimmernummerValue15}}<br><b>Preistyp: </b>{{tableWintergarten.preistypValue15}}<br><b>Anreise: </b>{{tableWintergarten.anreiseValue15}}<br><b>Abreise:</b> {{tableWintergarten.abreiseValue15}}<br><b>Personen Anzahl:</b>{{tableWintergarten.personenAnzahlValue15}}<br><b>Reisebüro: </b>{{tableWintergarten.rbsouValue15}}<br><b>Notiz2:</b> {{tableWintergarten.notiz2Value15}}<br><b>Trace:</b> {{tableWintergarten.trace15}}</div>\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                </div>\n                <div *ngIf=\"tableWintergarten.newTraceText\">\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tableWintergarten.newTraceRoomNumber}}<br> <b> Neuer Trace: </b>{{tableWintergarten.newTraceText}} <br> <b> Tischnummer: </b>{{tableWintergarten.newTraceTableNumber}} <br> <b> Mitarbeiter: </b>{{tableWintergarten.newTraceEmployee}} <br> <b> Name: </b>{{tableWintergarten.newTraceName}} <br> <b> Datum: </b>{{tableWintergarten.newTraceDate}}\n                  </div>\n                </div>\n                <div *ngIf=\"tableWintergarten.newTraceText1\">\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tableWintergarten.newTraceRoomNumber1}}<br> <b> Neuer Trace: </b>{{tableWintergarten.newTraceText1}} <br> <b> Tischnummer: </b>{{tableWintergarten.newTraceTableNumber1}} <br> <b> Mitarbeiter: </b>{{tableWintergarten.newTraceEmployee1}} <br> <b> Name: </b>{{tableWintergarten.newTraceName1}} <br> <b> Datum: </b>{{tableWintergarten.newTraceDate1}}\n                  </div>\n                </div>\n                <div *ngIf=\"tableWintergarten.newTraceText2\">\n                  <li class=\"divider dropdown-divider\" style=\"padding: 0 0 0 0\"></li>\n                  <div class=\"dropdown-item\"  style=\"background-color: #FFFFFF; border: solid 3px red\">\n                    <b> Zimmernummer: </b>{{tableWintergarten.newTraceRoomNumber2}}<br> <b> Neuer Trace: </b>{{tableWintergarten.newTraceText2}} <br> <b> Tischnummer: </b>{{tableWintergarten.newTraceTableNumber2}} <br> <b> Mitarbeiter: </b>{{tableWintergarten.newTraceEmployee2}} <br> <b> Name: </b>{{tableWintergarten.newTraceName2}} <br> <b> Datum: </b>{{tableWintergarten.newTraceDate2}}\n                  </div>\n                </div>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div *ngIf=\"showAlleBool\">\n        <br>\n        <br>\n        <br>\n        <h1 style=\"color: white; margin-top: 100px\">Perfekt um eine Suche zu starten ;-)</h1>\n      </div>\n    </div>\n  </div>\n</div>\n"
    ...
    TischplanComponent.prototype.getTables = function () {
        ...
        this.tischplanService.getTables()
            ...
            if (tables === null) {
                ...
                var testTables = [{ number: "512" }, { number: "501" }, { number: "505" }, { number: "507" }, { number: "508" }, { number: "509" }, { number: "510" }, { number: "511" }, { number: "503" }, { number: "513" }, { number: "514" }, { number: "515" }, { number: "517" }, { number: "519" }, { number: "521" }, { number: "522" }, { number: "523" }];
                ...
                var sortedTablesWintergarten = tables[3].tables.sort();
                console.log('sorted:');
