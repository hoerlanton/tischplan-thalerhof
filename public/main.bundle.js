...
var TischplanComponent = (function () {
    ...
    TischplanComponent.prototype.occupy = function (tableSonnbergZirbn, i) {
        var _this = this;
        this.tischplanService.occupyTable(tableSonnbergZirbn).subscribe(function (tableSonnbergZirbn) {
            _this.bgColorsSonnbergZirbn[i] = tableSonnbergZirbn.bgColor;
            /*
