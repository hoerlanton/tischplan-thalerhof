...
var PrintComponent = (function () {
    function PrintComponent() {
        ...
        this.tableNumbers = [];
        this.tableTemp = [];
        this.tablesSortedByDate = [];
        this.tablesSortedByName = [];
        this.sumOfGuests = [];
        this.sumOfGuestsHP = [];
        this.sumOfGuestsF = [];
        this.trace = false;
    ...
    PrintComponent.prototype.formatAzList = function (tables) {
        ...
        console.log("this.tables");
        console.log(this.tables);
        var myClonedArray = Object.assign([], this.tableTemp);
