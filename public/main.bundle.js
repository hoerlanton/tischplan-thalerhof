...
var TischplanComponent = (function () {
    ...
    TischplanComponent.prototype.printToCart1 = function (printSectionId1) {
        ...
        popupWinindow.document.write('<html><head><link rel="stylesheet" type="text/css" href="tischplan.printTables.css"/><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">\n' +
            '    <script src="node_modules/core-js/client/shim.min.js"></script>\n' +
    ...
    TischplanComponent.prototype.printToCart2 = function (printSectionId2) {
        ...
        popupWinindow = window.open('', '_blank', 'width=600,height=700,scrollbars=no,menubar=no,toolbar=no,location=no,status=no,titlebar=no');
        popupWinindow.document.open();
        popupWinindow.document.write('<html><head><style> html, body { padding: 0; margin: 0; height: 100%; background-color: #0a7a74; } .row { height: 100%; } .row .container-fluid { height: 100%; } .row .container-fluid .col-md-4 { background-color: #f3efe4; padding: 20px 10px 20px 10px; border-left: 10px solid #0a7a74; border-right: 10px solid #0a7a74; height: 100%; border-bottom: 20px solid #0a7a74; max-width: 20%; } .row .container-fluid .col-md-4 .row1 { overflow: auto; margin: 0 0 0 0; display: inline-block; width: 100%; height: 25%; padding-top: 20px; } .row .container-fluid .col-md-4 .row1 .wrapper { overflow: auto; margin: 0 0 0 0; display: inline-block; max-width: 100%; } .row .container-fluid .col-md-4 .row1 .wrapper .container { overflow: auto; margin: 0 0 0 0; display: inline-block; max-width: 100%; } .row .container-fluid .col-md-4 .row3 { margin: 0 auto; display: inline-block; width: 100%; height: 100%; padding-top: 20px; } .row .container-fluid .col-md-4 .col-xs-12 .row1 { overflow: auto; margin: 0 auto; display: inline-block; width: 100%; height: 100%; padding-top: 20px; } .row .container-fluid .col-md-4 h3 { align-content: center; margin: 0 auto; display: inline-block; color: #0a7a74; position: relative; text-align:center; } .row .container-fluid .col-md-4 .row3 .col-xs-12 .form-group { border-top:3px solid #0a7a74; width: 105%; padding: 10px 10px 10px 30px; } .row .container-fluid .col-md-4 .row3 .col-xs-12 .group { border-top:3px solid #0a7a74; width: 105%; padding: 10px 10px 10px 30px; } .row .container-fluid .col-md-4 .row3 .col-xs-12 .form-group1 { margin-top: 20px; overflow: auto; max-height: 300px; display: inline-block; border-top:3px solid #0a7a74; width: 102%; padding: 10px 10px 10px 25px; } .row1 .col { flex: 1; } .row1 .col:nth-child(1) { order: 1; } .row1 .col:nth-child(2) { order: 0; } .row1 .col:nth-child(3) { order: 2; } .row .col-md-4 .row2 { padding-bottom: 10px; position: relative; min-height: 100%; border-bottom: 1px solid red; } .card { background: rgb(255,255,255); /* Fall-back for browsers that don support rgba */ background: rgba(255,255,255, 1); } .row .container-fluid .col-md-4 .row1 .wrapper .container .card p { padding:10px 10px 10px 10px; max-width: 100%; } .row .container-fluid .col-md-4 .wrapper .container .card p { padding:10px 10px 10px 10px; max-width: 100%; } .row .container-fluid .col-md-4 .row3 .row1 p { padding: 10px 10px 10px 10px; background: rgb(255,255,255); /* Fall-back for browsers that don support rgba */ background: rgba(255,255,255, 1); max-width: 100%; } .row .container-fluid .col-md-4 .col-xs-12 .row1 .wrapper .container .card p { padding: 10px 10px 10px 10px; max-width: 100%; } .row .container-fluid .col-md-6 { height: 620px; width: 58%; background-color: #eaf3f3; } .row .container-fluid .col-md-6 .print-section1 .row { background-color: #eaf3f3; height: 620px; position: relative; } .row .container-fluid .col-md-6 .row1 .col-md-3 { margin: 0px 0px 0px 0px; padding: 20px 20px 20px 20px; } .row .t1 { width: 30px; height: 60px; position: absolute; border: solid 1px #eaf3f3; } .row .t2 { width: 30px; height: 60px; position: absolute; border: solid 1px #eaf3f3; } .row .t3 { width: 30px; height: 60px; position: absolute; border: solid 1px #eaf3f3; } .row .t4 { width: 30px; height: 60px; position: absolute; border: solid 1px #eaf3f3; } .row .t5 { width: 30px; height: 80px; border: solid 1px #eaf3f3; position: absolute; } .row .t6 { width: 30px; height: 80px; border: solid 1px #eaf3f3; position: absolute; } .row .t7 { width: 30px; height: 80px; border: solid 1px #eaf3f3; position: absolute; } .row .t8 { width: 100px; height: 90px; border: solid 1px #eaf3f3; position: absolute; } .row .t9 { width: 40px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t10 { width: 40px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t11 { width: 30px; height: 80px; border: solid 1px #eaf3f3; position: absolute; } .row .t12 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t13 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t14 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t15 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t16 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t17 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t40 { width: 60px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t41 { width: 60px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t42 { width: 80px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t43 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t44 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t45 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t46 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t47 { width: 80px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t48 { width: 60px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t49 { width: 60px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t50 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t51 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t52 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t53 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t54 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t55 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t56 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t57 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t58 { width: 60px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t60 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t61 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t62 { width: 30px; height: 60px; position: absolute; border: solid 1px #eaf3f3; } .row .t63 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t64 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t65 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t66 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; } .row .t67 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t68 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t69 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t70 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t71 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t72 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t73 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t74 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t75 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t76 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t77 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t78 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t79 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t80 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t81 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t82 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t83 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t84 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t85 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t86 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t87 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t88 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t89 { width: 60px; height: 30px; border: solid 1px #eaf3f3; position: absolute; } .row .t501 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t502 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; } .row .t503 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t504 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t505 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t506 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t507 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t508 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t509 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t510 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t511 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t512 { width: 80px; height: 45px; border: solid 1px #eaf3f3; position: absolute; } .row .t513 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t514 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; border-radius: 50%; } .row .t515 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t516 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t517 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(10deg); } .row .t518 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(30deg); } .row .t519 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(50deg); } .row .t520 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(70deg); } .row .t521 { width: 30px; height: 60px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(90deg); } .row .t522 { width: 80px; height: 45px; border: solid 1px #eaf3f3; position: absolute; } .row .t523 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t524 { width: 40px; height: 40px; border: solid 1px #eaf3f3; position: absolute; transform: rotate(45deg); } .row .t525 { width: 40px; height: 40px; position: absolute; transform: rotate(45deg); } </style></head><body onload="window.print()">' + innerContents + '</html>');
        popupWinindow.document.close();
    };
